...
const double redf_ee_array[LFA_NDATA][2] = {
    {2.4848, 1.1964},    {3.4393, 1.4586},   {4.6837, 1.9177},
    {6.2755, 2.5694},    {8.8284, 3.4426},   {12.0226, 4.1577},
    {16.3726, 4.6562},   {22.2964, 5.0213},  {30.8611, 5.2639},
    {42.7158, 5.6234},   {59.1241, 5.8397},  {81.8354, 6.1799},
    {111.4445, 6.6645},  {146.9125, 7.1197}, {203.3458, 7.678},
    {281.4568, 8.2023},  {389.5724, 9.1858}, {505.2769, 10.1905},
    {746.3477, 12.1917}, {968.0156, 15.0048}};
...
double etempLFA(const double Tg, double C[], const double EN)
{
    ...
    if (loc == 0)
    {
        EE_interp = redf_ee_array[loc][1] +
                    (redf_ee_array[loc + 1][1] - redf_ee_array[loc][1]) /
                        (redf_ee_array[loc + 1][0] - redf_ee_array[loc][0]) *
                        (EN - redf_ee_array[loc][0]);
    } else
    {
        EE_interp = redf_ee_array[loc][1] +
                    (redf_ee_array[loc][1] - redf_ee_array[loc - 1][1]) /
                        (redf_ee_array[loc][0] - redf_ee_array[loc - 1][0]) *
                        (EN - redf_ee_array[loc][0]);
    }
