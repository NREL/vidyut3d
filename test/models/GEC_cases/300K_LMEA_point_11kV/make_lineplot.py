...
for i, fn in enumerate(fn_list):
    ...
    dx_frb=probsize/res
    fields_load=["Potential","E","Electron_energy","Electron_Temp"]
    ...
    np.savetxt("linedata_"+axialdir_char+"%4.4d.dat"%(i),\
            np.transpose(np.vstack((xarr,potl,edenl,etempl,eenrgl,ejl,elhl,inelhl))),delimiter="  ")
